...
namespace Reyx.Nfe.Schema200.Envio.Cancelamento
{
    ...
    public class infEvento
    {
        ...
        /// <summary>
        /// Código do órgão de recepção do Evento. Utilizar a Tabela do IBGE, utilizar 91 
        ...
        /// informação utilizada para a SEFAZ validar o grupo detEvento.
        /// </summary>
        [XmlElement]
        ...
        /// </summary>
        [XmlElement]
        public Reyx.Nfe.Schema200.Envio.detEvento detEvento { get; set; }
    }
}